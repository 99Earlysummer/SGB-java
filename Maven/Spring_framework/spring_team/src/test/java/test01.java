...
public class test01 {
    ...
    public void UserT(){
        ...
        System.out.println("bean01 = " + myUser3);
    }
    @Test
    public void UserT2(){
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("spring-core.xml","spring-core02.xml");
        Object myUser3 = applicationContext.getBean("myUser3");
    ...
    @Test
    public void UserT3(){
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("spring-core03.xml");
