package com.atguigu.meinian.uilts;
...
public class SMSUtils {
    ...
    public static void sendShortMessage(String phoneNumbers,String param) throws Exception{
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAI4Fbws3CCEzKx3JPHqXQCabc";// 你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "3XFb3eNq6IDZ5Ik3x10vo9YHHzMGBzabc";// 你的accessKeySecret，参考本文档步骤2
        ...
        request.setTemplateParam("{\"number\":\""+1234+"\"}");
